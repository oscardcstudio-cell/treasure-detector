...
| Orthophotos 1950-1965 | **absentes de l'annexe `ortho.xml`** | Avant remembrement — talus, chemins creux, parcellaire ancien | **[À VÉRIFIER]** : probablement servies uniquement par `remonterletemps.ign.fr` et non en WMTS. Si confirmé, il faudra les exporter à la main plutôt que les consommer en flux |
